...
Insert custom sets as text files in the folder name pokemonSets. It is important that file names equal the Pokemons nickname. For example `nickname.txt`. League are saved in JSON format.
