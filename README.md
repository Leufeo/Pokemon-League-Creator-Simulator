...
Insert custom sets as text files in the folder named pokemonSets. It is important that the file names equal the Pokemons nickname. For example `nickname.txt`. Leagues are saved in JSON format.
